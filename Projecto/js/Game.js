class Game{
	...
	createShip(x,y,z){
		...
		materials["phongdouble"]= new THREE.MeshPhongMaterial({ color: 0x0081b4, wireframe: true, side: THREE.DoubleSide, shininess:10,specular:0xffffff})
	...
	createAliens(aliensPerRow, rows){
		...
		var materials= {}
		materials["phong"]= new THREE.MeshPhongMaterial({color: 0xff0000,  wireframe: true,  shininess:40,specular:0x555555});
		...
		materials["phongCockpit"]= new THREE.MeshPhongMaterial({color: 0x00ff00,  wireframe: true,  shininess:40,specular:0x555555});
